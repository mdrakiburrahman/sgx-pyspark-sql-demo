...
> 💡 Confidential analytics in this context is meant to imply: **_"run analytics on PII data with peace of mind against data exfiltration"_ - this includes potential `root`-level access breach both internally (rogue admins) or externally (system compromise).**
